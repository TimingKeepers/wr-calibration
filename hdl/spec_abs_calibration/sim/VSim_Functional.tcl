...
if { $sim_task == "load"} {
	...
	puts "elf file used for lm32 in WRPC: [set elf_file_lm32_wrpc "..\\..\\sw\\embedded\\wrpc-sw-simu\\wrc.elf"]"
...
#	exec cmd.exe /c data2mem.exe -bd $elf_file_lm32_2nd -d -o m lm32_2nd_memory.mem
	...
	vsim -voptargs="+acc" -novopt \
		+nowarn151 \
		+nowarn8684 \
		-G/spec_top_tb/u1/g_simulation=$g_simulation \
    -G/spec_top_tb/u5/U_GTP/g_simulation=$g_simulation \
    -G/spec_top_tb/u5/U_WR_CORE/g_simulation=$g_simulation \
		-G/spec_top_tb/u5/U_WR_CORE/WRPC/DPRAM/g_must_have_init_file=true \
		-G/spec_top_tb/u5/U_WR_CORE/WRPC/DPRAM/g_init_file=lm32_wrpc_memory.ldr \
		-t ps -L unisim -lib work work.spec_top_tb

#    -G/spec_top_tb/u2/tx_data_swap=false \
	...
	#	force MAC address
	force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.mach_o 16#$mach_o
	force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.macl_o 16#$macl_o

#  force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/U_Rx_Path/pfilter_pclass 16#0

	#	Packet Filter Enable
#	force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.pfcr0_enable_o 1
	#	Packet Transmit Path Enable
#  force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.ecr_tx_en_o 1
	#	Packet Receive Path Enable
#  force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.ecr_rx_en_o 1
	#	Packet Receive Path, avoid "is_giant" error because mru is still default 0. Set it to 9000 bytes
  #  force -freeze /spec_top_tb/u5/U_WR_CORE/WRPC/U_Endpoint/U_Wrapped_Endpoint/regs_fromwb.rfcr_mru_o "10001100101000"

	force -freeze /spec_top_tb/clk_20m_vcxo_p_i 1, 0 25 ns -rep 50 ns
	#force -freeze /spec_top_tb/clk_20m_vcxo_n_i 0, 1 25 ns -rep 50 ns

	force -freeze /spec_top_tb/button1_i 0, 1 4 us
	force -freeze /spec_top_tb/Rx_Fire 0
	# "Fire" Starts transmission of UDP packets to Linux Server.
	force -freeze /spec_top_tb/button2_i 1
  #	force -freeze /spec_top_tb/udp_tstgen_cont '0'
  ...
  #	force -freeze /spec_top_tb/U_WR_CORE/Readout 1
  ...
  #run 500 us so wrpc lm32 has initialized the endpoint registers
	...
	# run 10 us
	# force -freeze /spec_top_tb/U_WR_CORE/u0/U_WR_CORE/WRPC/rst_net_n 0, 1 1 us
	# run 10 us
	# noforce /spec_top_tb/U_WR_CORE/u0/U_WR_CORE/WRPC/rst_net_n

	# THIS FORCE RX_CDR_LOCK 1 SHOULD NOT BE NESECAIRRY! IS THERE STILL SOMETHING NOT OKAY?
	#force -freeze /spec_top_tb/u0/U_GTP/rx_cdr_lock 1

  # Disable any write transfer from the State Machine:
  #force -freeze /spec_top_tb/U_WR_CORE/u16/gen_tdc/wrap_stmach/U_Wrapped_stmach/Wrapped_stmach/U_stmach/wrreqi "00"
...
if { $testrx == true} {
	...
	force -freeze /spec_top_tb/Rx_Fire 1,0 128 ns
	
	run 800 ns

    # Test Pause frame generation after WaterMarkHigh
#    force -freeze /spec_top_tb/U_WR_CORE/U_WR_CORE/u6/u2/WaterMarkHigh 1
	run 80 us
#    noforce /spec_top_tb/U_WR_CORE/U_WR_CORE/u6/u2/WaterMarkHigh

	
} else {
	# Test Transmit UDP packets to server PC

	force -freeze /spec_top_tb/button2_i 0,1 128 ns
